class Game 
{
  constructor() 
  {
//     Crie uma função constructor() em game.js para declarar propriedades para
// resetTitle e resetButton.
  ...
  // Crie handleElements() para dar posição e texto/imagem para resetTitle e para o
  // botão reset
  handleElements() 
  {
    form.hide();
...
//   Modifique handlePlayerControls() para adicionar condições para mover o carro com
// as teclas de seta para a esquerda e para a direita
  handlePlayerControls() 
  {
    ...
    if (keyIsDown(    ) && player.positionX > width / 3 - 50) 
    {
    
      player.update();
    }

    if (keyIsDown(     ) && player.positionX < width / 2 + 300) 
    {
